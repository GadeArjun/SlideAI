    ...
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      >
        ...
        <div className="flex items-center gap-4">
          <div
            className={`w-16 h-16 rounded-2xl bg-linear-to-br flex items-center justify-center text-white text-xl font-bold ${generateAvatarColor(
    ...
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      >
        <div className="flex items-center gap-2 mb-1">
          ...
          <span className="ml-2 text-xs bg-amber-100 text-amber-600 dark:bg-amber-950 dark:text-amber-400 px-2 py-0.5 rounded-full font-semibold">
            Coming Soon
          </span>
        </div>
