        ...
        >
                ...
                className={({ isActive }) =>
                  cn(
                    ...
                    isActive
                      ...
                      : highlight
                      ? "text-(--brand) hover:bg-blue-50 dark:hover:bg-blue-950"
          ...
          <div className="p-2 border-t border-(--border)">
            ...
            >
              <div
                className={cn(
                  "w-8 h-8 rounded-full bg-linear-to-br shrink-0 flex items-center justify-center text-white text-xs font-bold",
            ...
            {collapsed && (
              <button
                onClick={logout}
                className="btn-ghost w-full flex justify-center py-2"
                title="Logout"
              >
                <LogOut className="w-4 h-4" />
              </button>
